...
import docme; // #IMPORT: docme, Project Module
...
int main(int p_argc, char** p_argv){
    if(auto result = docme::engine::ConfigFile::createTemplate("test.json"); !result){
        docme::core::logger.error(result.error().message());
    }
    return EXIT_SUCCESS;
} // END: main(int, int**)
